...
function FirstSection() {
  return (
    <section>
        <h3>Llegaste al Hogar de las patitas felices</h3>
        <p>Bienvenido a mi servicio veterinario a domicilio. Soy Mariana Brand, una veterinaria independiente dedicada a brindar atención excepcional a todo tipo de mascotas, desde pequeños pájaros hasta imponentes perros de raza grande. Mi compromiso es ofrecerte un cuidado de alta calidad con la comodidad de que tus queridos compañeros estén en su propio hogar.</p>

        <img src={DogBone} className='img-bone'></img>
        <img src={DogPaw} className='img-paw'></img>
        <img src={DogPaw} className='img-paw2'></img>
        <img src={DogPaw} className='img-paw3'></img>
        <img src={DogPaw} className='img-paw4'></img>
    </section>
  );
}
